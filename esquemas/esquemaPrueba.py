...
def train_cnn_model(num_conv_layers, base_filter_value, use_batch_norm, lr, batch_size, epochs, cs_iter, cnn_count):
    ...
    train_path = '../../Datasets/dataset_procesado/train'
    valid_path = '../../Datasets/dataset_procesado/valid'
    test_path = '../../Datasets/dataset_procesado/test'
...
def ejecutarGWO(wolves,nwolves, maxIter):
    ...
    for wolf in wolves:
        ...
        best_value_per_iteration.append(final_average_valid_accuracy)
...
#esquema_num = int(input("Please enter the scheme number: "))  # Para esquemas interactivos tipo colab

esquema_num = 1  # Cambiar el n�mero para cambiar de esquema
esquema_name = f'Esquema{esquema_num}'  # Nombre de la carpeta de salida basado en esquema_num
...
print("\nBest Solution:")
print(f"Nido: {best_nest}, Value de F(x): {best_value}")
